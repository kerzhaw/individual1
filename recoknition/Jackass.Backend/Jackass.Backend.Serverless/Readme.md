...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Jackass.Backend.Serverless*):

Restore dependencies
```
    cd "Jackass.Backend.Serverless"
    dotnet restore
```

Execute unit tests
```
    cd "Jackass.Backend.Serverless/test/Jackass.Backend.Serverless.Tests"
    dotnet test
```

Deploy application
```
    cd "Jackass.Backend.Serverless/src/Jackass.Backend.Serverless"
